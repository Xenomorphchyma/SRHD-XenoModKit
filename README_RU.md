...
- Общие `TVar`, используемые как `Planet`, `Star` или `Ship`, проверяются на
  ...
  старой ссылки и восстановление через соответствующий `IdTo*`.
...
В наборе из 135 тестов используются нативные PNG/GI/QM/QMM-кодеки и локальные BlockParEditor/RScript:
