...
from srhd_modkit import (
    ...
    discover_mods, inspect_file, inspect_gi, load_blockpar, read_gi,
    read_png, stage_tree, verify_gi, write_gi, write_png,
)
...
108 тестов используют нативные PNG/GI-кодеки и локальные BlockParEditor/RScript:
...
таймауты, fail-closed восстановление и запрет GUI по умолчанию. Дополнительно
`dev`-аудит обработал все 418 установленных модов: 3345 проверок, 0 падений
валидаторов. Глубокая структурная проверка прошла для 3098 из 3131 локального
