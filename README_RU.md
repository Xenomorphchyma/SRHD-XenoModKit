...
- Полный набор 0.9.5 состоит из 213 тестов и 22 подтестов.
...
В наборе из 213 тестов используются нативные PNG/GI/QM/QMM-кодеки и локальные BlockParEditor/RScript:
