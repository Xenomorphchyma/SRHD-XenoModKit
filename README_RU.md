...
- Старая аварийная версия Coalition Supply Lines теперь блокируется по обеим
  причинам, исправленные версии проходят строгую проверку без замечаний.
...
В наборе из 137 тестов используются нативные PNG/GI/QM/QMM-кодеки и локальные BlockParEditor/RScript:
...
детерминированный JSON→QMM и единый аудит. Дополнительно
`dev`-аудит обработал все 418 установленных модов: 3762 проверки, 0 падений
