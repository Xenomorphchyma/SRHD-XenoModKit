...
- Безопасный кэш учитывает все входные SHA-256, параметры и точные версии/хэши внешних инструментов; кэшированный результат всё равно повторно проходит SCR/DAT и release-аудит. Старые ревизии ограничены автоматически (3 на артефакт/вариант, 256 записей и 2 ГиБ суммарно), а текущая сборка всегда защищена от очистки.
