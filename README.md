...
- Полный набор 0.9.4 состоит из 180 тестов, включая воспроизведение старого аварийного XenoDom, межпроцедурные predicates, `Dist` и безопасные формы отдельных guard.
