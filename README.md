...
В версии 0.8.3 проходит 91 тест; полный набор проверяет также лексический preflight,
адаптивные таймауты, fail-closed декомпиляцию, глубокий round-trip и сравнение
SCR. Дополнительно dev-аудит был выполнен на 418 установленных модах без падений валидаторов.
