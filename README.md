...
- Поддерживаются оба используемых модами расположения: компактный `DATA/Script/Lang.dat` и традиционные `CFG/<язык>/Lang.dat`. Для нескольких языков проверяется наличие каждого ключа без требования одинакового перевода.
...
- Полный набор 0.9.6 состоит из 256 тестов и 24 подтестов.
