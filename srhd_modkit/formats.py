...
FORMAT_SPECS: tuple[FormatSpec, ...] = (
    ...
    FormatSpec("RSON script project", (".rson",), "structured-text", "headless", "SRHD ModKit + RScript", "scr/rsm"),
    FormatSpec("RSM modular script", (".rsm",), "script-project", "headless", "SRHD ModKit + rsmc", "scr"),
    FormatSpec("SVR legacy script project", (".svr",), "script-project", "headless", "RScript 4.10f compatibility", "rson"),
