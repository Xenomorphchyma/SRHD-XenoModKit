...
`runtime-group-mutated-during-iteration` требует обратный обход либо явное
уменьшение курсора после удаления. Ещё безопаснее — закончить обработчик и
продолжить на следующем ходу.
