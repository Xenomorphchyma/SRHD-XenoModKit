...
ModKit 0.8.2 не конструирует неизвестные типы объектов из догадок. Вместо этого
...
ModKit 0.8.2 умеет безопасно менять эту сигнатуру, не затирая обработчик:
...
Если исходник всё же потерян, ModKit 0.8.2 умеет автоматически вызвать
