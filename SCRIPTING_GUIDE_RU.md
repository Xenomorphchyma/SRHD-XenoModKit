...
ModKit 0.8.3 не конструирует неизвестные типы объектов из догадок. Вместо этого
...
ModKit 0.8.3 умеет безопасно менять эту сигнатуру, не затирая обработчик:
...
Если исходник всё же потерян, ModKit 0.8.3 умеет автоматически вызвать
