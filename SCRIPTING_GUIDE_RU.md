...
ModKit 0.5.7 не конструирует неизвестные типы объектов из догадок. Вместо этого
...
ModKit 0.5.7 умеет безопасно менять эту сигнатуру, не затирая обработчик:
...
ходу. Поэтому ModKit 0.5.7 блокирует такие связи как
