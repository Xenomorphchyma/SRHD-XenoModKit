...
`TDialogAnswer → числовой ключ RScript → Script/<ScriptName>/<key>` и проверяют
оба используемых игрой расположения: компактный `DATA/Script/Lang.dat` и
традиционные `CFG/<язык>/Lang.dat`.
